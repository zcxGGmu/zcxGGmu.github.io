...
ASSET_ROOT = TASKS / "video-batch-20260909-bv11a-bv1tz-bv1mh-bv19x"
CHART_ROOT = ASSET_ROOT / "generated-slide-charts"
DRAFTS = TASKS / "drafts"
POST_MANIFEST = DRAFTS / "20260909-video-batch-bv11a-bv1tz-bv1mh-bv19x-posts.json"
OUT_DIR = Path("/tmp/video-batch-bv11a-bv1tz-bv1mh-bv19x-20260909-output")
...
pub.base.BASE_DT = datetime(2026, 9, 9, 23, 59, 30, tzinfo=timezone(timedelta(hours=8)))
pub.base.PREV_EXISTING_URL = "/2026/zhongji-innolight-ai-optical-interconnect-silicon-photonics/"
pub.base.PREV_EXISTING_TITLE = "AI 算力的隐形动脉：中际旭创、1.6T 光模块与硅光时代"
pub.base.SCRIPT_NAME = Path(__file__).name
pub.base.MANIFEST_NAME = "publish-video-batch-bv11a-bv1tz-bv1mh-bv19x-20260909-changed-files.json"
...
def create_commit(outputs: dict[str, str | None], binary_outputs: dict[str, bytes], ref) -> str:
    ...
    commit = api_json(
        ...
        {"message": "Publish video-derived articles 2026-09-09 batch 2", "tree": tree["sha"], "parents": [ref.commit_sha]},
    )
    api_json(
        "PATCH",
