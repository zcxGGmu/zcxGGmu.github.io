...
PREV_WRAPPER = TASKS / "publish-video-batch-bv11a-bv1tz-bv1mh-bv19x-20260909.py"
ASSET_ROOT = TASKS / "video-batch-20260909-bv1ef-bv152-bv184-bv1nm-bv1ed-bv1co-bv1a4"
CHART_ROOT = ASSET_ROOT / "generated-slide-charts"
DRAFTS = TASKS / "drafts"
POST_MANIFEST = DRAFTS / "20260909-video-batch-bv1ef-bv152-bv184-bv1nm-bv1ed-bv1co-bv1a4-posts.json"
OUT_DIR = Path("/tmp/video-batch-bv1ef-bv152-bv184-bv1nm-bv1ed-bv1co-bv1a4-20260909-output")
...
pub.base.BASE_DT = datetime(2026, 9, 9, 23, 59, 50, tzinfo=timezone(timedelta(hours=8)))
pub.base.PREV_EXISTING_URL = "/2026/electrolytic-aluminum-dividend-repricing/"
pub.base.PREV_EXISTING_TITLE = "电解铝的红利化：产能封顶、现金流重估与绿电溢价"
pub.base.SCRIPT_NAME = Path(__file__).name
pub.base.MANIFEST_NAME = "publish-video-batch-bv1ef-bv152-bv184-bv1nm-bv1ed-bv1co-bv1a4-20260909-changed-files.json"
...
def api_json(method: str, endpoint: str, payload: dict | None = None) -> dict:
    ...
    headers = {
        ...
        "User-Agent": "codex-publisher/2026-09-09",
    }
...
def create_commit(outputs: dict[str, str | None], binary_outputs: dict[str, bytes], ref) -> str:
    ...
    for path, content in sorted(binary_outputs.items()):
        try:
            entries.append({"path": path, "mode": "100644", "type": "blob", "content": content.decode("utf-8")})
    ...
    commit = api_json(
        ...
        {"message": "Publish video-derived articles 2026-09-09 batch 3", "tree": tree["sha"], "parents": [ref.commit_sha]},
    )
    api_json(
        "PATCH",
