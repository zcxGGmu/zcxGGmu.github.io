...
PREV_WRAPPER = TASKS / "publish-video-batch-bv1rp-bv1xw-bv1b2-bv1w8-20260911.py"
ASSET_ROOT = TASKS / "video-batch-20260911-bv1kc-bv1bf-bv1vt-bv14wsz-bv14wvm"
CHART_ROOT = ASSET_ROOT / "generated-slide-charts"
DRAFTS = TASKS / "drafts"
POST_MANIFEST = DRAFTS / "20260911-video-batch-bv1kc-bv1bf-bv1vt-bv14wsz-bv14wvm-posts.json"
OUT_DIR = Path("/tmp/video-batch-bv1kc-bv1bf-bv1vt-bv14wsz-bv14wvm-20260911-output")
...
pub.base.BASE_DT = datetime(2026, 9, 11, 23, 59, 59, tzinfo=timezone(timedelta(hours=8)))
pub.base.PREV_EXISTING_URL = "/2026/grok-build-codex-claude-code-coding-agent-comparison/"
pub.base.PREV_EXISTING_TITLE = "26K Star 的 Grok Build：和 Codex、Claude Code 到底差在哪？"
pub.base.SCRIPT_NAME = Path(__file__).name
pub.base.MANIFEST_NAME = "publish-video-batch-bv1kc-bv1bf-bv1vt-bv14wsz-bv14wvm-20260911-changed-files.json"
...
def create_commit(outputs: dict[str, str | None], binary_outputs: dict[str, bytes], ref) -> str:
    ...
    commit = api_json(
        ...
        {"message": "Publish video-derived articles 2026-09-11 batch 2", "tree": tree["sha"], "parents": [ref.commit_sha]},
    )
    api_json(
        "PATCH",
