...
{fig(SLUG, 'paper-outline-clean.jpg', '论文目录把问题拆成可逆效应、响应式余效应、组件加载器与元定理，核心是时空可组合性。')}
...
{fig(SLUG, 'runtime-fiber-rules-clean.jpg', '组件加载与卸载被拆成一串有状态的效应迭代，而不是一次性完成的黑箱动作。')}
...
{fig(SLUG, 'component-loader-clean.jpg', '组件加载器把 ctx.effect、ctx.use、ctx.set 等命令式原语组织为声明式的动态组合过程。')}
...
SCREENSHOT_SOURCES = {
    SLUG: [
        ("paper-outline.jpg", "paper-outline-clean.jpg"),
        ("runtime-fiber-rules.jpg", "runtime-fiber-rules-clean.jpg"),
        ("component-loader.jpg", "component-loader-clean.jpg"),
    ]
}
