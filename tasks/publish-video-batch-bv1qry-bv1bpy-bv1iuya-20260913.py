...
PREV_WRAPPER = TASKS / "publish-video-batch-bv1kc-bv1bf-bv1vt-bv14wsz-bv14wvm-20260911.py"
ASSET_ROOT = TASKS / "video-batch-20260913-bv1qry-bv1bpy-bv1iuya"
CHART_ROOT = ASSET_ROOT / "generated-slide-charts"
DRAFTS = TASKS / "drafts"
POST_MANIFEST = DRAFTS / "20260913-video-batch-bv1qry-bv1bpy-bv1iuya-posts.json"
OUT_DIR = Path("/tmp/video-batch-bv1qry-bv1bpy-bv1iuya-20260913-output")
...
pub.base.DATE = "2026-09-13"
pub.base.BASE_DT = datetime(2026, 9, 13, 23, 59, 50, tzinfo=timezone(timedelta(hours=8)))
pub.base.PREV_EXISTING_URL = "/2026/ai-pcb-ccl-glass-cloth-copper-foil-supply-chain/"
pub.base.PREV_EXISTING_TITLE = "AI 算力硬件进入材料瓶颈期：PCB、CCL、电子布与铜箔的量价齐升"
pub.base.SCRIPT_NAME = Path(__file__).name
pub.base.MANIFEST_NAME = "publish-video-batch-bv1qry-bv1bpy-bv1iuya-20260913-changed-files.json"
...
def api_json(method: str, endpoint: str, payload: dict | None = None) -> dict:
    ...
    headers = {
        ...
        "User-Agent": "codex-publisher/2026-09-13",
    }
...
def create_commit(outputs: dict[str, str | None], binary_outputs: dict[str, bytes], ref) -> str:
    ...
    commit = api_json(
        ...
        {"message": "Publish video-derived articles 2026-09-13 batch 1", "tree": tree["sha"], "parents": [ref.commit_sha]},
    )
    api_json(
        "PATCH",
