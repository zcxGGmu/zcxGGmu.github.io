...
date: "2025-11-10T15:51:26+08:00"
updated: "2025-11-11T10:38:20+08:00"
slug: "hexo-next-github搭建blog"
description: "使用GitHub page + hexo + NexT主题的搭建方式"
categories: 
  - "博客搭建"
tags: 
  - "博客搭建"
...
<li><p>静态网页仓库，这个仓库里的静态网页都是hexo生成的。我们把这个仓库推到如上的<br>username.github.io这个仓库，然后从浏览器就可有通过<a target="_blank" rel="noopener" href="https://username.github.io/">https://username.github.io</a><br>访问到。</p>
</li>
...
<p>Note: 上面安装的nodejs是10.x.x的，后面生成博客的时候会报错，我们这里需要安装<br>  12.x.x的nodejs版本。nodejs的版本可以通过node -v 来看。</p>
</li>
<li><p>安装12.x.x nodejs</p>
<p>curl -sL <a target="_blank" rel="noopener" href="https://deb.nodesource.com/setup_12.x">https://deb.nodesource.com/setup_12.x</a> | sudo -E bash -<br>sudp apt update<br>sudo apt install -y nodejs</p>
</li>
<li><p>下载hexo和NexT</p>
